...
namespace eval ::optrace {
  variable script "D:/SUTD/50.002 CompStruc/1D GAME/work/vivado/1D GAME/1D GAME.runs/impl_1/au_top_0.tcl"
...
OPTRACE "set parameters" START { }
  ...
  set_property ip_output_repo {{D:/SUTD/50.002 CompStruc/1D GAME/work/vivado/1D GAME/1D GAME.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{D:/SUTD/50.002 CompStruc/1D GAME/work/vivado/1D GAME/1D GAME.runs/synth_1/au_top_0.dcp}}
